<?php namespace Core\Database\Drivers;
...
final class PDO
{
    ...
    {
        try {
            $this->connection = @new \PDO("mysql:host=" . $host . ";port=" . (!empty($post) ? $port : 3306) . ";dbname=" . $name, $user, $pass, array(\PDO::ATTR_PERSISTENT => true));
